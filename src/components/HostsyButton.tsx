...
interface HostsyButtonProps extends Omit<HTMLMotionProps<"button">, keyof React.ButtonHTMLAttributes<HTMLButtonElement>> {
    ...
    <motion.button
      ...
      className={cn(
        "font-medium rounded-xl transition-all focus:outline-none focus:ring-2 focus:ring-coral/50",
        {
          ...
          "text-coral hover:bg-coral/5": variant === "ghost",
